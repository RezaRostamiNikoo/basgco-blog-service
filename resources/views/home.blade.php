                ...
                <div class="col-md-4 col-12 mt-5">
                    <div class="features text-center">
                        ...
                        <div class="content mt-4">
                            ...
                            <p class="text-muted mb-0">گفته می شود ، یک محقق لاتین با تدوین کلمه ای غیر معمول ، اصل متن
                                ایجاد شده را تأسیس کرد.</p>
                        </div>
                    </div>
                </div><!--end col-->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ms-lg-5">
                        ...
                        <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می
                            توانید
                            یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                        <ul class="list-unstyled mb-0 text-muted">
                            ...
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
                                        class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد
                                و با
                                تجربه ما
                            </li>
                            <li class="mb-0"><span class="text-primary h5 me-2"><i
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span>
                            که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم
                            کند.</p>
                    </div>
                </div><!--end col-->
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>دسترسی کامل
                                </li>
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>فایل های منبع
                                </li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                    <div class="card pricing-rates business-rate shadow bg-white border-0 rounded">
                        <div class="ribbon ribbon-right ribbon-warning overflow-hidden"><span
                                class="text-center d-block shadow small h6">بهترین </span></div>
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                ...
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>قرار ملاقات رایگان
                                </li>
                            </ul>
                    ...
                    <div class="card pricing-rates business-rate shadow bg-light border-0 rounded">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                ...
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>1 دامنه رایگان
                                </li>
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>امنیت پیشرفته
                                </li>
                            </ul>
                    ...
                    <div class="card pricing-rates business-rate shadow bg-light border-0 rounded">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0 ps-0">
                                ...
                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                            class="uil uil-check-circle align-middle"></i></span>اقساط رایگان
                                </li>
                            </ul>
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                ...
                                <div class="flex-1 content p-3 shadow rounded bg-white position-relative">
                                    ...
                                    <p class="text-muted mt-2">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم
                                        اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                    <h6 class="text-primary">- دین لوس <small class="text-muted">توسعه دهنده </small>
                                    </h6>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title">
                        ...
                        <div class="mt-4 pt-2">
                            <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary">شروع
                                کنید
                                <span class="badge rounded-pill bg-danger ms-2">ورژن 3.1.1 </span></a>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
