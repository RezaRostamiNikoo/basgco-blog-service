                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                ...
                                <p>شرکت برج افرازان شاهین گستر</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ \Illuminate\Support\Facades\Auth::user()->getFirstMediaUrl('avatars') }}"
                        ...
                        <div class="col-sm-8">
                            <div class="pt-4">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h5 class="font-size-15">{{count(\Illuminate\Support\Facades\Auth::user()->posts)}}</h5>
                                        <p class="text-muted mb-0">کل مقالات</p>
                                    </div>
                                    <div class="col-6">
                                        <h5 class="font-size-15">{{count(\Illuminate\Support\Facades\Auth::user()->posts)}}</h5>
                                        <p class="text-muted mb-0">منتشر شده</p>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <a href="" class="btn btn-primary waves-effect waves-light btn-sm">مشاهده پروقابل<i
                                            class="mdi mdi-arrow-left ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
