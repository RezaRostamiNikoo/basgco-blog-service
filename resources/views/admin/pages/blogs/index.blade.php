                                        ...
                                        @foreach($posts as $post)
                                            <div>
                                                <div class="d-flex justify-content-between">
                                                    <h5>
                                                        <div vclass="text-dark">{{$post->title}}</div>
                                                        <div class="text-muted">{{$post->sub_title}}</div>
                                                    </h5>
                                                    <p class="text-muted">{{\Morilog\Jalali\Jalalian::forge($post->created_at)->format('ساعت %H:%m - مورخ %d  %B %Y')}}</p>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-2">
                                                        <div class="position-relative mb-3">
                                                            <img
                                                                src="{{ $post->getFirstMediaUrl('posts','thumbnail') }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-row-reverse justify-content-between">
                                                            <div class="d-flex gap-2">
                                                                <a href="{{route('admin.blogs.edit',['blog'=> $post->slug])}}"
                                                                   class="text-primary d-flex justify-content-end">
                                                                    اصلاح
                                                                    <i class="mdi mdi-file-edit"></i>
                                                                </a>
                                                                <a href="{{route('blogs.show',['blog'=> $post->slug])}}"
                                                                   class="text-primary d-flex justify-content-end">
                                                                    بیشتر
