        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route("home")}}" class="logo logo-dark">
                    <span class="logo-sm text-dark font-weight-bold" style="font-weight: bold">
                        بسگکو
{{--                        <img src="{{ URL::asset('/admin/assets/images/logo.svg') }}" alt="" height="22">--}}
                    </span>
                    <span class="logo-lg text-dark font-weight-bold" style="font-weight: bold">
...
{{--                        <img src="{{ URL::asset('/admin/assets/images/logo-dark.png') }}" alt="" height="17">--}}
                ...
                <a href="{{route("home")}}" class="logo logo-light">
                    <span class="logo-sm text-white font-weight-bold" style="font-weight: bold">
                                             بسگکو
{{--   <img src="{{ URL::asset('/admin/assets/images/logo-light.svg') }}" alt="" height="22">--}}
                    </span>
                    <span class="logo-lg text-white font-weight-bold" style="font-weight: bold">
                                                برج افرازان شاهین گستر
...
{{--                        <img src="{{ URL::asset('/admin/assets/images/logo-light.png') }}" alt="" height="19">--}}
        ...
        <div class="d-flex">
            ...
            {{--                            <div class="d-flex">--}}
            {{--                                <img--}}
            {{--                                    src="{{ \Illuminate\Support\Facades\Auth::user()->getFirstMediaUrl('avatars','profile') }}"--}}
