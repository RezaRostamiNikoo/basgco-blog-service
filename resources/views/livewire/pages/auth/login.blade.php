                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('/admin/assets/images/logo-dark.png') }}" alt="" height="18" class="auth-logo-dark">
                                            <img src="{{ URL::asset('/admin/assets/images/logo-light.png') }}" alt="" height="18" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">برای دسترسی به امکانات وبسایت لطفا وارد شوید</p>
                                        </div>
